...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 90990 99099</li>	
					<li class="s-bar">
						<div class="search">
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 90990 99099</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> New Naroda Road, Ahmedabad, India</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2024 SUNRISE . All Rights Reserved | Design by <a href="index.php">DCEMPIRE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
